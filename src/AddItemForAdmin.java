...
public class AddItemForAdmin extends JDialog {
...
//	private JTextField cardNum;
	...
	public static void display(ShopController c){
		AddItemForAdmin dialog = new AddItemForAdmin(c);
...
//	}
	...
	public AddItemForAdmin(ShopController c) {
		...
		{
			JLabel lblPhoneNumber = new JLabel("Set the Price of item:");
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e) {
						c.getBackend().getProducts().add(toProduct());
